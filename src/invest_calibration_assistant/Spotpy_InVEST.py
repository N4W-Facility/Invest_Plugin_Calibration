...
#   - Best-fit parameter: highlighted in InVEST's own brand green, so the
#     figure reads as part of the same product as the Workbench and the
#     HTML report (see Report_InVEST.py).
_DOT_FACE   = '#D9D9D9'   # light gray fill
_DOT_EDGE   = '#8C8C8C'   # darker gray edge
_BEST_COLOR = '#148F68'   # InVEST brand green
